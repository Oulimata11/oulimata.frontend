...
assiduite_note: ["", Validators.required],
ponctualite_note: ["", Validators.required],
satisfaction_client_note: ["", Validators.required],
...
assiduite_note: [note_to_edit.assiduite_note, Validators.required],
ponctualite_note: [note_to_edit.ponctualite_note, Validators.required],
satisfaction_client_note: [note_to_edit.satisfaction_client_note, Validators.required],
date_note: [note_to_edit.date_note, Validators.required],
